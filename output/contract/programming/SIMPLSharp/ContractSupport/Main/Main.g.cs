...
namespace Classroom.Main
{
    ...
    public partial interface IMain 
    {
        ...
        /// <summary>
        /// ComplexComponent Display-Powering-Off
        /// </summary>
        Classroom.Main.IDisplayPoweringOff DisplayPoweringOff { get; }

        /// <summary>
        /// ComplexComponent AirMedia-Code
        /// </summary>
        Classroom.Main.IAirMediaCode AirMediaCode { get; }

        /// <summary>
        /// ComplexComponent Display-Power-Off-Confirm
        /// </summary>
        Classroom.Main.IDisplayPowerOffConfirm DisplayPowerOffConfirm { get; }

        /// <summary>
        /// ComplexComponent Display-Processing
        /// </summary>
        Classroom.Main.IDisplayProcessing DisplayProcessing { get; }

        /// <summary>
        /// ComplexComponent Display-Powering-On
        /// </summary>
        Classroom.Main.IDisplayPoweringOn DisplayPoweringOn { get; }

        /// <summary>
        /// ComplexComponent System-Initializing
        /// </summary>
        Classroom.Main.ISystemInitializing SystemInitializing { get; }

        /// <summary>
        /// ComplexComponent Vacancy Alert
        /// </summary>
        Classroom.Main.IVacancyAlert VacancyAlert { get; }
    }
    ...
    internal partial class Main : IMain, IDisposable
    {
        ...
        private static class Joins
        {
            ...
            internal static class Booleans
            {
                ...
                /// </summary>
                public const uint VolumeMuteButton_SelectedState = 22;
        ...
        private void Initialize(uint controlJoinId, uint? itemCount)
        {
            ...
            DisplayPoweringOff = new Classroom.Main.DisplayPoweringOff(ComponentMediator, 2);
            AirMediaCode = new Classroom.Main.AirMediaCode(ComponentMediator, 3);
            DisplayPowerOffConfirm = new Classroom.Main.DisplayPowerOffConfirm(ComponentMediator, 5);
            DisplayProcessing = new Classroom.Main.DisplayProcessing(ComponentMediator, 6);
            DisplayPoweringOn = new Classroom.Main.DisplayPoweringOn(ComponentMediator, 7);
            SystemInitializing = new Classroom.Main.SystemInitializing(ComponentMediator, 8);
            VacancyAlert = new Classroom.Main.VacancyAlert(ComponentMediator, 9);
        }
        ...
        public void AddDevice(BasicTriListWithSmartObject device)
        {
            ...
            ((Classroom.Main.DisplayPoweringOff)DisplayPoweringOff).AddDevice(device);

            ((Classroom.Main.AirMediaCode)AirMediaCode).AddDevice(device);

            ((Classroom.Main.DisplayPowerOffConfirm)DisplayPowerOffConfirm).AddDevice(device);

            ((Classroom.Main.DisplayProcessing)DisplayProcessing).AddDevice(device);

            ((Classroom.Main.DisplayPoweringOn)DisplayPoweringOn).AddDevice(device);

            ((Classroom.Main.SystemInitializing)SystemInitializing).AddDevice(device);

            ((Classroom.Main.VacancyAlert)VacancyAlert).AddDevice(device);
        }
        ...
        public void RemoveDevice(BasicTriListWithSmartObject device)
        {
            ...
            ((Classroom.Main.DisplayPoweringOff)DisplayPoweringOff).RemoveDevice(device);

            ((Classroom.Main.AirMediaCode)AirMediaCode).RemoveDevice(device);

            ((Classroom.Main.DisplayPowerOffConfirm)DisplayPowerOffConfirm).RemoveDevice(device);

            ((Classroom.Main.DisplayProcessing)DisplayProcessing).RemoveDevice(device);

            ((Classroom.Main.DisplayPoweringOn)DisplayPoweringOn).RemoveDevice(device);

            ((Classroom.Main.SystemInitializing)SystemInitializing).RemoveDevice(device);

            ((Classroom.Main.VacancyAlert)VacancyAlert).RemoveDevice(device);
        }
        ...
        /// <summary>
        /// ComplexComponent DisplayPoweringOff
        /// </summary>
        public Classroom.Main.IDisplayPoweringOff DisplayPoweringOff { get; private set; }

        /// <summary>
        /// ComplexComponent AirMediaCode
        /// </summary>
        public Classroom.Main.IAirMediaCode AirMediaCode { get; private set; }

        /// <summary>
        /// ComplexComponent DisplayPowerOffConfirm
        /// </summary>
        public Classroom.Main.IDisplayPowerOffConfirm DisplayPowerOffConfirm { get; private set; }

        /// <summary>
        /// ComplexComponent DisplayProcessing
        /// </summary>
        public Classroom.Main.IDisplayProcessing DisplayProcessing { get; private set; }

        /// <summary>
        /// ComplexComponent DisplayPoweringOn
        /// </summary>
        public Classroom.Main.IDisplayPoweringOn DisplayPoweringOn { get; private set; }

        /// <summary>
        /// ComplexComponent SystemInitializing
        /// </summary>
        public Classroom.Main.ISystemInitializing SystemInitializing { get; private set; }

        /// <summary>
        /// ComplexComponent VacancyAlert
        /// </summary>
        public Classroom.Main.IVacancyAlert VacancyAlert { get; private set; }
